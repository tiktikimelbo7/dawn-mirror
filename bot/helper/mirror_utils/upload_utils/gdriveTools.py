...
class GoogleDriveHelper:
    ...
    def drive_list(self, fileName, stopDup=False, noMulti=False, isRecursive=True, itemType=""):
        ...
        for index, parent_id in enumerate(DRIVES_IDS):
            ...
            for file in response.get('files', []):
                ...
                if mime_type == "application/vnd.google-apps.folder":
                    ...
                    furl = short_url(furl)
                    msg += f"<b><a href={furl}>Google Link</a></b>"
                    if INDEX_URLS[index] is not None:
                        ...
                        url = short_url(url)
                        msg += f' <b>| <a href="{url}"> Cloudflare Link </a></b>'
                    ...
                    if INDEX_URLS[index] is not None:
                        ...
                        if VIEW_LINK:
                            ...
                            urls = short_url(urls)
                            msg += f' <b>| <a href="{urls}">Cloud Link</a></b>'
                msg += '<br><br>'
                contents_count += 1
        ...
        path = [
            telegraph.create_page(title='Developer Jackssmit', content=content)[
                "path"
            ]
